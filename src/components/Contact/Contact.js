...
const Contact = () => {
    return (
        <div className={classes.Contact} id ="contact">
            ...
            <FaLinkedin color= 'white' size= '50px' style={{padding: '1%'}}
            onClick={handleURL('https://www.linkedin.com/in/haley-brown-b64a6727/')} />
            <FaGithub color= 'white' size= '50px' style={{padding: '1%'}}
            onClick={handleURL('https://github.com/Hbrown16')} />
            <FaPhoneAlt color= 'white' size= '50px' style={{padding: '1%'}}
            onClick={handleURL('https://hihello.me/p/cd3a643f-eb5e-4e32-b8f3-6aa060130695')} />
            <FaMailBulk color= 'white' size= '50px' style={{padding: '1%'}}
